export default function MethodologyPage() {
  return (
    <div className="page-stack methodology-page">
      <header className="page-heading"><div><p className="page-context">Reproduction and limitations</p><h1>Methodology</h1><p>The benchmark keeps data selection, prompt configuration, runtime measurements, raw responses, and scoring artifacts available for inspection.</p></div></header>
      ...
      <section className="download-section"><div className="section-title"><h2>Download artifacts</h2><p>Use the complete exports for independent analysis.</p></div><div><a href={`${import.meta.env.BASE_URL}downloads/benchmark-results.json`} download>Complete benchmark results <span>JSON</span></a><a href={`${import.meta.env.BASE_URL}downloads/case-results.csv`} download>Per-case scores <span>CSV</span></a><a href={`${import.meta.env.BASE_URL}downloads/aggregate-results.csv`} download>Aggregate scores <span>CSV</span></a><a href="https://github.com/Beingpax/Dataset-VoiceInk-Cleanup/blob/main/comparison/benchmark/README.md">Reproduction notes <span>MD</span></a></div></section>
    </div>
  );
}
